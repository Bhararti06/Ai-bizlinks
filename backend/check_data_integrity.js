...
async function checkIntegrity() {
    try {
        ...
        const [trainings] = await pool.execute('SELECT organization_id, COUNT(*) as count FROM trainings GROUP BY organization_id');
        ...
        const tables = ['users', 'meetings', 'events', 'trainings', 'member_categories', 'membership_plans'];
